...
export const routeRegistry: RouteDefinition[] = [
  { id: "project-home", label: "项目主页", englishLabel: "Project home", group: "project", state: "live" },
  { id: "languages", label: "所有语言", englishLabel: "All languages", group: "project", state: "live" },
  { id: "genealogy", label: "语言谱系", englishLabel: "Language family", group: "project", state: "live" },
  { id: "events", label: "历史事件", englishLabel: "Historical events", group: "project", state: "live" },
  { id: "project-settings", label: "项目设置", englishLabel: "Project settings", group: "project", state: "prototype" },
  { id: "language-overview", label: "概览", englishLabel: "Overview", group: "language", state: "live" },
  { id: "language-properties", label: "基本属性", englishLabel: "Properties", group: "language", state: "live" },
  { id: "stages", label: "阶段管理", englishLabel: "Stages", group: "language", state: "live" },
  { id: "dialects", label: "方言", englishLabel: "Dialects", group: "language", state: "live" },
  { id: "phonology", label: "语音学", englishLabel: "Phonology", group: "language", state: "live" },
  { id: "morphology", label: "形态学", englishLabel: "Morphology", group: "language", state: "live" },
  { id: "lexicon", label: "词典", englishLabel: "Lexicon", group: "language", state: "live" },
  { id: "writing", label: "书写系统", englishLabel: "Writing system", group: "language", state: "prototype" },
  { id: "evolution", label: "演化", englishLabel: "Evolution", group: "language", state: "live" },
  { id: "contact", label: "词源与接触", englishLabel: "Etymology & contact", group: "language", state: "live" },
