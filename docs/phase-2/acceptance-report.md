...
状态：**外部验收部分通过；真实项目已修复，Lexurgy 安装版启动修正版正在重新验收，Phase 2 尚未结项。**
...
- 安装包大小：`50,931,588` 字节
- 安装包 SHA-256：
  `BFDD03E46C66190E4FB84724D38D9E2347FE7D217F5E49557AD4BE7360CF67FA`
- 签名状态：未签名（开发阶段安装包）
...
2026-07-26 Sidecar 路径修正版完整运行结果：**通过**。Jest 15 个测试套件、62 项测试通过；
Cypress 15 个规格、80 项测试通过；Rust 15 项测试通过；Lexurgy 全部上游和桌面
