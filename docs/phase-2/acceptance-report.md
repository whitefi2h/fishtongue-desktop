...
状态：**外部验收部分通过；测试词音变、错误定位和屈折已通过，正式词典入口修正版正在重新验收，Phase 2 尚未结项。**
...
- 安装包大小：`50,934,690` 字节
- 安装包 SHA-256：
  `7E541CA8AFF05641E45F6DBBACF99C001F4A631C047B3101D9BDB0C8C42DAF15`
- 签名状态：未签名（开发阶段安装包）
...
Cypress 15 个规格、81 项测试通过；Rust 16 项测试通过；Lexurgy 全部上游和桌面
